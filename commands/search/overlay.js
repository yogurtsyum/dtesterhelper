...
module.exports = class OverlayCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'overlay',
            aliases: ['o'],
            group: 'search',
            memberName: 'overlay',
            description: 'Searches the overlay bug reports board.',
            args: [
                {
                    key: 'query',
    ...
    async run (message, { query }) {
        ...
        let cards = await fetch('https://api.trello.com/1/boards/k6jr4NyY/cards');
