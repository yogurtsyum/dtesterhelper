...
module.exports = class iOSCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'ios',
            aliases: ['i'],
            group: 'search',
            memberName: 'ios',
            description: 'Searches the iOS bug reports board.',
            args: [
                {
                    key: 'query',
    ...
    async run (message, { query }) {
        ...
        let cards = await fetch('https://api.trello.com/1/boards/vLPlnX60/cards');
